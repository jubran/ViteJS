...
import FileManagerGridView from 'src/sections/file-manager/file-manager-grid-view';
...
export default function FusCards() {
    ...
    <>
      ...
      >
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          <Typography variant="h4">تفريغ الوقود</Typography>
