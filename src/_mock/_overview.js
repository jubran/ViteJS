...
export const _crudeSkid_One = [
  {
    id: _mock.id(0),
    name: _mock.ftsNames(0),
    avatarUrl: _mock.ftsNames(0),
    type: _mock.ftsTypes(1),
    message: _mock.ftsNames(0),
    category: _mock.ftsTypes(0),
    status: _mock.operationType(0),

  },
  {
    id: _mock.id(1),
    name: _mock.ftsNames(1),
    avatarUrl: _mock.ftsNames(1),
    type: _mock.ftsTypes(1),
    message: _mock.ftsNames(1),
    category: _mock.ftsTypes(1),
    status: _mock.operationType(1),
  },
  {
    id: _mock.id(2),
    name: _mock.ftsNames(2),
    avatarUrl: _mock.ftsNames(2),
    type: _mock.ftsTypes(1),
    message: _mock.ftsNames(2),
    category: _mock.ftsTypes(1),
    status: _mock.operationType(1),
  },
  {
    id: _mock.id(3),
    name: _mock.ftsNames(3),
    avatarUrl: _mock.ftsNames(3),
    type: _mock.ftsTypes(1),
    message: _mock.ftsNames(3),
    category: _mock.ftsTypes(3),
    status: _mock.operationType(2),
  },
  {
    id: _mock.id(4),
    name: _mock.ftsNames(4),
    avatarUrl: _mock.ftsNames(4),
    type: _mock.ftsTypes(1),
    message: _mock.ftsNames(4),
    category: _mock.ftsTypes(1),
    status: _mock.operationType(2),
  },
];
export const _crudeSkid_Tow = [
  {
    id: _mock.id(0),
    name: _mock.ftsNames(0),
    avatarUrl: _mock.ftsNames(0),
...
export const _dieselBOP = [
  {
    id: _mock.id(0),
    name: _mock.ftsNames(0),
    avatarUrl: _mock.ftsNames(0),
    type: _mock.ftsTypes(0),
    message: _mock.ftsNames(0),
    category: _mock.ftsTypes(0),
    status: _mock.operationType(0),
  },
  ...
  {
    id: _mock.id(5),
    name: _mock.ftsNames(5),
    avatarUrl: _mock.ftsNames(5),
    type: _mock.ftsTypes(1),
    message: _mock.ftsNames(5),
    category: _mock.ftsTypes(0),
    status: _mock.operationType(2),
  },
];
...
{
  id: _mock.tankName(0),
  tankName: _mock.tankName(0),
  tankNumber: _mock.tankNumber(0),
  avatarUrl: _mock.tankName(0),
  fuelType: _mock.fuelType(0),
  tankStatus: ["SERVICE", "FILLING", "RETUERN"],
},
{
  id: _mock.tankName(1),
  tankName: _mock.tankName(1),
  tankNumber: _mock.tankNumber(1),
  avatarUrl: _mock.tankName(1),
  fuelType: _mock.fuelType(1),
  tankStatus: ["SETLLING"],
},
{
  id: _mock.tankName(2),
  tankName: _mock.tankName(2),
  tankNumber: _mock.tankNumber(2),
  avatarUrl: _mock.tankName(2),
  fuelType: _mock.fuelType(2),
  tankStatus: ["SETLLING"],
}
]
// BOOKING
